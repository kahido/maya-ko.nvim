...
hl.common = {
  ...
  FoldColumn = { fg = colors.bg_light, bg = options.transparent and 'none' or colors.bg },
  Folded = { fg = colors.gray, bg = options.transparent and 'none' or colors.bg },
